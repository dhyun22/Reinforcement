...
class ValueIterationAgent(ValueEstimationAgent):
        ...
        for i in range(self.iterations):
            ...
            for state in states:
                ...
                for action in actions:
                    ...
                    finalValue = max(finalValue, currentValue)
                storage[state] = finalValue
            self.values = storage
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for nextState, prob in transitionStatesAndProbs:
            qValue += (self.mdp.getReward(state, action,
                                          nextState) + (self.discount * self.values[nextState])) * prob
        return qValue
